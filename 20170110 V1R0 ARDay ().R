...
Current$Shift=NULL
Current$Shift2=NULL
Day <- subset(Current, Shift3 == '08:00 AM-05:00 PM')

##################### Use limited data #############


dataset2 <- Day[c(  "EmployeeCode", "EmployeeName", "AGSExperienceInMonths", "Gender", "EmployeeAge"
...
(333+160)*100/(333+160+24+31) #  89.9635
################# 6 Export Model Score #################

t <- cbind(dataset2, predAll1)
t$Prediction <- ifelse(predAll1>0.5, "Leave", "Stay")
write.csv(t, file="ARDay_Logit_Score_R0.csv", row.names=FALSE)
