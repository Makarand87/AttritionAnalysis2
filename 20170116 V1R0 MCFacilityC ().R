...
levels(Current$Client)[is.na(Current$Client)] <- "AGS" #  Maximum number of categories (50) exceeded
...
data.frame(table(Current$Shift2))
...
dataset2 <- Current[c(  "EmployeeCode", "EmployeeName", "AGSExperienceInMonths", "Gender", "EmployeeAge"
                        ...
                        , "Shift", "TransportMode","EngagementIndex", "FunctionName", "Status", "Attrition", "Available")]
