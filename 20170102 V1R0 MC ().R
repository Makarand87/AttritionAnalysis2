...
D2 <- gsub(",", "", D1, fixed=FALSE); class(D2); head(D2, 20)
Current$Distance <- as.numeric(D2); head(Current$Distance, 20)
...
################# 4 Model 1 (all IMP) #######################
# + Last30DaysLeaveCount+ TotalExtraHoursWorked + LastReviewType + LastReviewRating + RMonth + SubClient
...
(1303+1279)*100/(1303+1279+251+309) # 82.17696 after considering EmployeeAge + JMonth + Client
